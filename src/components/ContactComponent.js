...
// Form work in class component with state, state of form need to be store in state.
class Contact extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            telnum: '',
            email: '',
            agree: false, //boonlean
            contactType: 'Tel', //Use to select form control
            message: '',
            touched: {
                firstname: false,
                lastname: false,
    ...
    handleBlur = (field) => (evt) => {
        this.setState({
            touched: {...this.state.touched, [field]: true } //Chọn hết tất cả state con trong touched bằng ... và cho mỗi state con = field một giá trị mới là true
        })
    } 
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.telnum && !reg.test(telnum))
            error.telnum = 'Tel. number should be numbers'
    ...
    handleSubmit(event) {
        ...
        event.preventDefault(); //Chặn không cho chuyển trang khi bấm submit
    }
                    ...
                    <div className='col-12 cold-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            <FormGroup row>
                                ...
                                <Col md={10}> {/*10 columns Medium to extra large screen size, similar to div class col-md-10*/} 
                            ...
                            <FormGroup row>
                              ...
                              <FormGroup row>
                                ...
                                <Col md={10}> {/*10 columns Medium to extra large screen size, similar to div class col-md-10*/} 
                                    <Input type='text' id='telnum' name='telnum' placeholder='Telephone Number' value={this.state.telnum}
                                        valid={error.telnum == ''}
                            ...
                            <FormGroup row>
                                <Col md={{ size: 6, offset: 2 }}>
                                    <FormGroup check> {/*Check for checkbox */}
                                        <Label check>
                                            <Input type='checkbox' name='agree' check={this.state.agree} onChange={this.handleInputChange}/>{' '} <strong>May we contact you?</strong>
                                        </Label> 
                                    </FormGroup>
                                </Col>
